...
(function(){
    window.onload = function () {
        ...
        var displayIndex = function (imgSize, spacing, left, imgs, index, flat, width, titleBox) {
            Array.from(document.querySelectorAll('tbody tr')).forEach(function (el) {
                el.classList.remove('active')
            })
            Array.from(document.querySelectorAll('tbody tr'))[index].classList.toggle('active')
            ...
            if (imgs[index].dataset.info) {
                ...
                titleBox.href = imgs[index].dataset.link;
        ...
        var initCoverFlow = function (c) {
            ...
            // if (!shadow) {
                ...
                titleBox.style.padding = "3px 10px";
                titleBox.style.color = "#222";
                titleBox.style.background = "#ddd";
                titleBox.style.borderRadius = "15px";
